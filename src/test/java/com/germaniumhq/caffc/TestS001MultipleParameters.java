...
i8size = 0;
errors = 0;
_caffc_temp_caffc_u32_1
  = caffc_check((caffc_str*)&caffc_cstr_4c1dc1f491eb4e4e, 1, i8size);
...
return 0;
        ...
        assertCodeContains(code, """
caffc_u32 caffc_check(caffc_str* typeName, caffc_u32 expectedSize,
  caffc_u32 actualSize) {
""",
